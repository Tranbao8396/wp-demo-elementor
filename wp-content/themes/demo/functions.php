 ...
 * ---------------------------------------------------------*/
function add_menu( $wp_admin_bar ) {
    global $template;
...
add_action( 'admin_bar_menu', 'add_menu', 9999 );
...
function load_css_js() {
    ...
    // wp_enqueue_style( 'swiper', $css . '/swiper.min.css', array(), false );
    wp_enqueue_style( 'style', $css . '/main.css', array(), false );
...
function setup() {
    ...
    if ( function_exists( 'add_image_size' ) ) {
         add_image_size('thumb-274x210', 274, 210, true);
    }
}
